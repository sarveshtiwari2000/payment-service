...
public class PaymentPlan {
    ...
    public PaymentPlan(final Request request) {
        ...
        this.date = processPaymentDate(request.getStartDate());
    ...
    public PaymentPlan(final Request request, final PaymentPlan previousPaymentPerMonth, final int counter) {
        this.initialOutstandingPrincipal = roundOff(previousPaymentPerMonth.getRemainingOutstandingPrincipal());
        this.date = processPaymentDate(request.getStartDate(), counter);
        this.interest = roundOff(calculateInterest(BigDecimal.valueOf(request.getNominalRate())));
    ...
    private String processPaymentDate(final String startDateTime) {
        final LocalDate startDate = convertStringToLocalDate(startDateTime);
        return convertLocalDateToString(startDate);
    }

    private String processPaymentDate(final String startDateTime, final int counter) {
        final LocalDate startDate = convertStringToLocalDate(startDateTime);
